Action()
{
	...
	lr_start_transaction("Insert_CustomerProfile");
	...
	lr_end_transaction("Insert_CustomerProfile",LR_AUTO);
	...
	lr_start_transaction("Insert_FlightsInfo");
	...
	lr_end_transaction("Insert_FlightsInfo",LR_AUTO);
